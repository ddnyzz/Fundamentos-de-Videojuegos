...
Es devuelto al inicio (Habitación de Rupert)
Es sometido a medicación.
Estos tratamientos afectan su percepción.

Mecánica Narrativa
El mundo del juego cambia con cada intento:
El entorno se vuelve menos claro.
Algunas rutas pueden cambiar (Prueba)
El jugador puede interactuar con el entorno mediante acciones simples:
Apuntar hacia objetos 
Activar o desactivar mecanismos (puertas, luces, obstáculos).
Alterar el comportamiento de ciertos elementos del entorno. (Prueba)
Estas acciones pueden funcionar de manera diferente según el estado de Rupert. Un mismo objeto puede reaccionar de forma distinta dependiendo del nivel de medicación, generando incertidumbre sobre qué acciones son correctas. (Prueba)
Estos cambios representan el deterioro de la percepción de Rupert.

Objetivo
Escapar del hospital, adaptándose a los cambios del entorno en cada intento.

La historia se presenta de forma simple y breve, a través de:
Mensajes cortos (Estilo dialogo)
Cambios en el entorno (Deterioro del entorno)
No se ofrece una explicación definitiva sobre la condición de Rupert

Idea central
El juego plantea que cada intento de “corregir” a Rupert lo aleja más de una percepción clara de la realidad
